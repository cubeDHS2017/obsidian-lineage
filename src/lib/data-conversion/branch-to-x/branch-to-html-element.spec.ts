...
describe('branch-to-html-element', () => {
    test('case 1', () => {
        ...
        const text = `1a <span data-section="1"/>
1b

1.1 <span data-section="1.1"/>

1.1.1 <span data-section="1.1.1"/>

1.1.2 <span data-section="1.1.2"/>

1.1.2.1 <span data-section="1.1.2.1"/>

1.2 <span data-section="1.2"/>

1.2.1 <span data-section="1.2.1"/>

1.2.2 <span data-section="1.2.2"/>`;
    ...
    test('multiple branches', () => {
        ...
        const text = `1 <span data-section="1"/>

1.1 <span data-section="1.1"/>

1.2 <span data-section="1.2"/>

2 <span data-section="2"/>

2.1 <span data-section="2.1"/>

2.2 <span data-section="2.2"/>`;
